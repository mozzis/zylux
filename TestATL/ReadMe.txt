========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : TestATL
========================================================================


AppWizard has created this TestATL application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your TestATL application.
...
res\TestATL.ico
    ...
    icon is included by the main resource file TestATL.rc.
...
TestATLDlg.h, TestATLDlg.cpp - the dialog
    These files contain your CTestATLDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in TestATL.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CTestATLDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named TestATL.pch and a precompiled types file named StdAfx.obj.
