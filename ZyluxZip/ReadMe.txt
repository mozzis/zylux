========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : ZyluxZip
========================================================================


AppWizard has created this ZyluxZip application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your ZyluxZip application.
...
ZyluxZip.h
    ...
    CZyluxZipApp application class.
...
res\ZyluxZip.ico
    ...
    icon is included by the main resource file ZyluxZip.rc.
...
ZyluxZipDlg.h, ZyluxZipDlg.cpp - the dialog
    These files contain your CZyluxZipDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in ZyluxZip.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CZyluxZipDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named ZyluxZip.pch and a precompiled types file named StdAfx.obj.
