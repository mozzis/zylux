...
#include "InjectorToolBar.h"	// Added by ClassView
...
protected:  // control bar embedded members
	...
	CToolBar m_wndRunBar;
	CInjectorToolBar m_wndInjectorBar;
...
protected:
	...
	afx_msg void OnViewRunbar();
	afx_msg void OnUpdateViewRunbar(CCmdUI* pCmdUI);
	afx_msg void OnViewInjectbar();
	afx_msg void OnUpdateViewInjectbar(CCmdUI* pCmdUI);
	//}}AFX_MSG
